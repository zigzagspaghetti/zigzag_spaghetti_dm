...
def zigzag_sp_function(adj, x, scaleParameter, beta_schedule, beta_1, beta_T, T): # adj, x, sorted_t are torch tensor
    ...
    zigzag_out = (torch.from_numpy(zigzag_out)).to(torch.float32)
